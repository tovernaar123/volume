...
float outputint =0; 
String hs = "0";
void boxall(float xbox1, float xbox2,float ybox1, float ybox2, float fillx, float filly) {
  ...
  fill[fill.length-1].make(fillx,filly);
...
void all_display(float x,float y ,float len) {
